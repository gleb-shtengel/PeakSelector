...
dx = CGroupParams[Xwid_ind,*]-PkWidth_offset
dy = CGroupParams[Ywid_ind,*]-PkWidth_offset

coeffs = [-1.0, dy, 0.0, -1.0*dx, 1.0]
roots = FZ_ROOTS(coeffs)

CGroupParams[Par12_ind,*]= FZ
