;------------------------------------------------------------------------------
;+
; This lifecycle method is called during the destruction of the PALM_ZoomMode
...
;-
;------------------------------------------------------------------------------
function PALM_ZoomMode::Init, oDisplay, $
    VERBOSE=verbose
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnKeyboard, oWindow, IsASCII, Character, KeySymbol, x, y, Press, Release, Modifiers
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnLeftButtonDown, x, y, Modifiers, NumClicks
    ...
    self.oDisplay -> Zoom, [x,y], /START, /NO_DRAW
    self.holdLeft = 1B
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnLeftButtonUp, x, y, Modifiers
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnMiddleButtonDown, x, y, Modifiers, NumClicks
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnMiddleButtonUp, x, y, Modifiers
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnMouseDown, oWindow, x, y, ButtonMask, Modifiers, NumClicks
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnMouseMotion, oWindow, x, y, ButtonMask, Modifiers, NumClicks
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnMouseUp, oWindow, x, y, ButtonMask, Modifiers, NumClicks
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnRightButtonDown, x, y, Modifiers, NumClicks
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnRightButtonUp, x, y, Modifiers
...
;-
;------------------------------------------------------------------------------
pro PALM_ZoomMode::OnWheel, oWindow, x, y, Delta, Modifiers
...
;------------------------------------------------------------------------------
;+
; Define the member variables of the PALM_ZoomMode class, along with various internal
;  structures.
; @File_comments
; This file defines the PALM_ZoomMode class for the framework of the application.
;
; @field
;   holdLeft
