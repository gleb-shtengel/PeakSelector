;------------------------------------------------------------------------------
;+
; This lifecycle method is called during the destruction of the PALM_RotateMode
...
;-
;------------------------------------------------------------------------------
function PALM_RotateMode::Init, oDisplay, $
    VERBOSE=verbose
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnKeyboard, oWindow, IsASCII, Character, KeySymbol, x, y, Press, Release, Modifiers
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnLeftButtonDown, x, y, Modifiers, NumClicks
    ...
    self.oDisplay -> TransformModel, [x,y], /START
    self.holdLeft = 1B
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnLeftButtonUp, x, y, Modifiers
    ...
    self.oDisplay -> TransformModel, [x,y], /RELEASE, /NO_DRAW
    self.holdLeft = 0B
...
;------------------------------------------------------------------------------
;+
; this method handles events from the middle mouse button
;
; @param
;   x {in}{type=long}{required}
;     X mouse position in device coordinates.
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnMiddleButtonDown, x, y, Modifiers, NumClicks
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnMiddleButtonUp, x, y, Modifiers
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnMouseDown, oWindow, x, y, ButtonMask, Modifiers, NumClicks
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnMouseMotion, oWindow, x, y, ButtonMask, Modifiers, NumClicks
    ...
    if self.holdLeft then begin
        self.oDisplay -> TransformModel, [x,y]
    endif
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnMouseUp, oWindow, x, y, ButtonMask, Modifiers, NumClicks
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnRightButtonDown, x, y, Modifiers, NumClicks
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnRightButtonUp, x, y, Modifiers
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode::OnWheel, oWindow, x, y, Delta, Modifiers
...
;------------------------------------------------------------------------------
;+
; Define the member variables of the PALM_RotateMode class, along with various
; internal structures.
;
; @File_comments
;   This file defines the PALM_PanMode class for the framework of the
;   application.
;
; @field
;   holdLeft
...
;-
;------------------------------------------------------------------------------
pro PALM_RotateMode__Define

    void = {PALM_RotateMode, $
            holdLeft   : 0B, $
            holdMiddle : 0B, $
            holdRight  : 0B, $
