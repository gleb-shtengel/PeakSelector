...
*/
extern void filterit(float *gp, int nparams, int npeaks, int nlimits, 
...
int IDL_CDECL IDL_Load(void) {
  ...
  static IDL_SYSFUN_DEF2 function_addr[] = {  
    {{(IDL_FUN_RET) idl_filter}, "CU_FILTERIT_F", 3, 3, 0, 0},
  };  

  /*  Error messages  */
  if (!(msg_block = IDL_MessageDefineBlock("FILTERIT_F", IDL_CARRAY_ELTS(msg_arr), msg_arr))) {
    return IDL_FALSE;  
  }
...
//dlm: MODULE CU_FILTERIT_F
//dlm: DESCRIPTION CUDA PeakSelector filtering (single precision), HHMI
//dlm: VERSION 1.0
//dlm: FUNCTION CU_FILTERIT_F 3 3
