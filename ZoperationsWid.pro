...
; 
; Generated on:	11/10/2021 15:55.34
; 
pro WID_BASE_Z_operations_event, Event
  ...
  case wTarget of
    ...
    Widget_Info(wWidget, FIND_BY_UNAME='WID_BUTTON_Use_Multiple_Guidestars_ZGS'): begin
      if( Tag_Names(Event, /STRUCTURE_NAME) eq 'WIDGET_BUTTON' )then $
        OnButton_Press_use_multiple_guidestars_ZGS, Event
    end
    ...
    Widget_Info(wWidget, FIND_BY_UNAME='WID_BUTTON_Use_Multiple_Guidestars_ZDH'): begin
      if( Tag_Names(Event, /STRUCTURE_NAME) eq 'WIDGET_BUTTON' )then $
        OnButton_Press_use_multiple_guidestars_ZDH, Event
    end
    else:
  endcase
...
pro WID_BASE_Z_operations, GROUP_LEADER=wGroup, _EXTRA=_VWBExtra_
  ...
  WID_BUTTON_Write_Guide_Star = Widget_Button(WID_BASE_Z_operations,  $
      UNAME='WID_BUTTON_Write_Guide_Star' ,XOFFSET=408 ,YOFFSET=362  $
      ,SCR_XSIZE=130 ,SCR_YSIZE=25 ,/ALIGN_CENTER ,VALUE='Write Guide'+ $
      ' Star')

  
  WID_BUTTON_Test_Guide_Star = Widget_Button(WID_BASE_Z_operations,  $
      UNAME='WID_BUTTON_Test_Guide_Star' ,XOFFSET=408 ,YOFFSET=335  $
      ,SCR_XSIZE=130 ,SCR_YSIZE=25 ,/ALIGN_CENTER ,VALUE='Test Guide'+ $
      ' Star')
  ...
  WID_BASE_WriteEllipticityGuideStar =  $
      ...
      UNAME='WID_BASE_WriteEllipticityGuideStar' ,XOFFSET=370  $
  ...
  WID_BUTTON_PickAncFile = Widget_Button(WID_BASE_Z_operations,  $
      UNAME='WID_BUTTON_PickAncFile' ,XOFFSET=380 ,YOFFSET=245  $
      ,SCR_XSIZE=150 ,SCR_YSIZE=25 ,/ALIGN_CENTER ,VALUE='Pick ANC'+ $
      ' File')

  
  WID_BUTTON_Use_Multiple_Guidestars_GS =  $
      Widget_Base(WID_BASE_Z_operations,  $
      UNAME='WID_BUTTON_Use_Multiple_Guidestars_GS' ,XOFFSET=380  $
      ,YOFFSET=275 ,TITLE='IDL' ,COLUMN=1 ,/NONEXCLUSIVE)

  
  WID_BUTTON_Use_Multiple_Guidestars_ZGS =  $
      Widget_Button(WID_BUTTON_Use_Multiple_Guidestars_GS,  $
      UNAME='WID_BUTTON_Use_Multiple_Guidestars_ZGS' ,/ALIGN_LEFT  $
  ...
  WID_BASE_WriteEllipticityGuideStar_E =  $
      Widget_Base(WID_BASE_Z_operations,  $
      UNAME='WID_BASE_WriteEllipticityGuideStar_E' ,XOFFSET=370  $
  ...
  WID_BUTTON_Use_Multiple_Guidestars_DH =  $
      Widget_Base(WID_BASE_Z_operations,  $
      UNAME='WID_BUTTON_Use_Multiple_Guidestars_DH' ,XOFFSET=380  $
      ,YOFFSET=305 ,TITLE='IDL' ,XPAD=5 ,COLUMN=1 ,/NONEXCLUSIVE)

  
  WID_BUTTON_Use_Multiple_Guidestars_ZDH =  $
      Widget_Button(WID_BUTTON_Use_Multiple_Guidestars_DH,  $
      UNAME='WID_BUTTON_Use_Multiple_Guidestars_ZDH' ,XOFFSET=5  $
      ,/ALIGN_LEFT ,VALUE='Use Multiple GuideStars DH')
